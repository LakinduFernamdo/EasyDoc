...
//Search patient API
    ...
    const UpdatePatient=async()=>{
        try {
            const response = await axios.patch('http://localhost:5000/auth/supervisor/patient-deatails/patient-update', selectedPatient);
    ...
    return (
        <div>
            ...
            {/* Button panel */}
            <div style={{ display: "flex", flexWrap: "wrap", gap: "10px", alignItems: "center", justifyContent: "center", marginBottom: "10px" }}>
                <button type="button" className="btn btn-primary" onClick={RegisterPatient}>Register Patient</button>
